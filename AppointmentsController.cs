...
namespace ShootingRangeAPI.Controllers
{
    ...
    public class AppointmentsController : ControllerBase
    {
        ...
        public async Task<IActionResult> CancelAppointment(int id)
        {
            ...
            appointment.IsActive = false; // Assuming you have an IsActive property to mark cancellation
    ...
    public class AppointmentCreateDto  //DTO = Data Transfer Object, designed to send data to the client
    {
