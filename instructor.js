    ...
    if (form) {
        form.addEventListener("submit", async function(event) {
            ...
            try {
                ...
                formData.append("QualificationFile", document.getElementById("minosites").files[0]);
                formData.append("IdCardFile", document.getElementById("igazolvany").files[0]);
                formData.append("CVFile", document.getElementById("cv").files[0]);
